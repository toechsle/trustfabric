...
import { ViewProjectDescriptionComponent } from '../../profile-consultants/view-project-description/view-project-description.component';
...
@Component({
  selector: 'app-view-team-member-profile',
  templateUrl: './view-team-member-profile.component.html',
  styleUrls: ['./view-team-member-profile.component.css']
})
export class ViewTeamMemberProfileComponent implements OnInit, OnDestroy {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any, private consultantService: ConsultantService, private dialog: MatDialog, private queriesService: QueriesService, private skillService: SkillService, private projectService: ProjectService) {}
